          ...
          inputSchema: {
            ...
            properties: {
              ...
              quality: {
                ...
                description:
                  "Quality level - affects aspect ratio: low/medium use 'auto', high uses 'square'",
              },
              aspectRatio: {
                type: 'string',
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    if (name === 'svgmaker_generate') {
      ...
      try {
        ...
        const { readFileToBuffer, resolveAndValidatePath, writeFile } = await import(
          './utils/fileUtils.js'
        );
